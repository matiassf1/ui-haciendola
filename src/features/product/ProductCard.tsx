...
interface IProductCard {
    ...
    onDelete: () => void; // Event handler for deleting the product
}

export const ProductCard = ({ product, onUpdate, onDelete }: IProductCard): JSX.Element => {
    return (
        <div className="relative max-w-sm rounded overflow-hidden h-[425px] shadow-lg bg-zinc-900 text-white mb-10">
